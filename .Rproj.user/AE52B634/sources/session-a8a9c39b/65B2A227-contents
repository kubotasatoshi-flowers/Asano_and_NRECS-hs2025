...
#データ表示範囲指定
from <- as.POSIXct("2025-08-22 06:00:00", tz = tz_use) 
to   <- as.POSIXct("2025-08-24 06:00:00", tz = tz_use)
...
p <- ggplot(
  ...
  ggtitle("Bubbling:Off, Well_Sv:25°C/24°C") +
  theme_minimal() +
...
ggsave("/cloud/project/figs/Temp_well_0822_0824.pdf",
       plot = p,
       device=cairo_pdf,
       width = 15,
       height = 9,
