...
\pandocbounded{\includegraphics[keepaspectratio]{../figs/greenhouse20251117.pdf}}
...
\toprule
センサー番号 & 設置場所 & 測定対象 & センサーの種類 & メーカー \\ 
\midrule\addlinespace[2.5pt]
① & 貯水槽 & 貯水槽水温 & サーミスタ & （株）オネスト \\ 
② & 貯水槽 & 井戸水供給水温 & サーミスタ & （株）オネスト \\ 
③ & 地下水熱源式HP & 一次側行き水温 & Pt100 & ATE様提供品 \\ 
④ & 地下水熱源式HP & 一次側戻り水温 & Pt100 & ATE様提供品 \\ 
⑤ & 地下水熱源式HP & 二次側行き水温 & サーミスタ & （株）ティアンドデイ \\ 
⑥ & 地下水熱源式HP & 二次側戻り水温 & サーミスタ & （株）ティアンドデイ \\ 
\shortstack[l]{⑦ \\　} & \shortstack[l]{空気熱源式HP \\　} & \shortstack[l]{室外機1 \\吸気側気温} & \shortstack[l]{サーミスタ \\　} & \shortstack[l]{（株）ティアンドデイ \\　} \\ 
\shortstack[l]{⑧ \\　} & \shortstack[l]{空気熱源式HP \\　} & \shortstack[l]{室外機1 \\排気側気温} & \shortstack[l]{サーミスタ \\　} & \shortstack[l]{（株）ティアンドデイ \\　} \\ 
\shortstack[l]{⑨ \\　} & \shortstack[l]{空気熱源式HP \\　} & \shortstack[l]{室外機2 \\吸気側気温} & \shortstack[l]{サーミスタ \\　} & \shortstack[l]{（株）ティアンドデイ \\　} \\ 
\shortstack[l]{⑩ \\　} & \shortstack[l]{空気熱源式HP \\　} & \shortstack[l]{室外機2 \\排気側気温} & \shortstack[l]{サーミスタ \\　} & \shortstack[l]{（株）ティアンドデイ \\　} \\ 
\shortstack[l]{⑪ \\　} & \shortstack[l]{空気熱源式HP \\　} & \shortstack[l]{二次側行き水温 \\　} & \shortstack[l]{Pt100 \\　} & \shortstack[l]{（株）立山科学 \\ハイテクノロジーズ} \\ 
\shortstack[l]{⑫ \\　} & \shortstack[l]{空気熱源式HP \\　} & \shortstack[l]{二次側戻り水温 \\　} & \shortstack[l]{Pt100 \\　} & \shortstack[l]{（株）立山科学 \\ハイテクノロジーズ} \\ 
\bottomrule
\end{tabular*}
...
センサー番号 & 設置場所 & 測定対象 & センサーの種類 & メーカー \\ 
\midrule\addlinespace[2.5pt]
⑬ & 温室 & 気温（強制通気筒内） & サーミスタ & （株）オネスト \\ 
⑭ & 地下水熱源式HP区N.RECS-st & 根域温度 & サーミスタ & （株）オネスト \\ 
\shortstack[l]{⑮ \\　} & \shortstack[l]{地下水熱源式HP区N.RECS-hs \\　} & \shortstack[l]{根域温度 \\　} & \shortstack[l]{Pt100 \\　} & \shortstack[l]{（株）立山科学 \\ハイテクノロジーズ} \\ 
⑯ & 地下水熱源式HP区N.RECS-ug & 根域温度 & サーミスタ & （株）オネスト \\ 
⑰ & 空気熱源式HP区N.RECS-st & 根域温度 & サーミスタ & （株）オネスト \\ 
\shortstack[l]{⑱ \\　} & \shortstack[l]{空気熱源式HP区N.RECS-hs \\　} & \shortstack[l]{根域温度 \\　} & \shortstack[l]{Pt100 \\　} & \shortstack[l]{（株）立山科学 \\ハイテクノロジーズ} \\ 
⑲ & 空気熱源式HP区N.RECS-ug & 根域温度 & サーミスタ & （株）オネスト \\ 
⑳ & 地下水熱源式HP & 二次側流速 & VN10R（パルス） & 愛知時計電機（株） \\ 
㉑ & 空気熱源式HP & 二次側流速 & VN10R（パルス） & 愛知時計電機（株） \\ 
\bottomrule
\end{tabular*}
...
\toprule
実験区 & 熱源の.br.設定水温 & 下限 & 上限 & 供試作物 \\ 
\midrule\addlinespace[2.5pt]
A-st区 & 10℃ & 20℃ & 22℃ & ガーデンシクラメン \\ 
A-hs区 & 10℃ & 20.5℃ & 21.5℃ & ガーデンシクラメン \\ 
A-ug区 & 10℃ & 20℃ & 22℃ & イチゴ／ガーベラ \\ 
W-st区 & 10℃ & 20℃ & 22℃ & ガーデンシクラメン \\ 
W-hs区 & 10℃ & 20.5℃ & 21.5℃ & ガーデンシクラメン \\ 
W-ug区 & 10℃ & 20℃ & 22℃ & イチゴ／ガーベラ \\ 
Control区 & なし & \begin{itemize}
\item 
\end{itemize} & \begin{itemize}
\item 
\end{itemize} & ガーデンシクラメン \\ 
\bottomrule
\end{tabular*}
