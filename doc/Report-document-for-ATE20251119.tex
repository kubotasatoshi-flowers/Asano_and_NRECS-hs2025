...
\textbf{?@fig-gre}
enに処理温室内におけるに熱源と各種N.RECS栽培装置の設置状況およびセンサーの設置位置を示した\}。同温室内には幅1.3
m，長さ9
...
× 10 × 100
cmのアルミ製カートリッジ45本からなり，各カートリッジには8Lの水を充填した。このカートリッジの上下をアルミ製熱交換パネルで挟みPEX管に冷温水を送液した。熱源から蓄熱槽および蓄熱槽から栽培槽への送液制御は，オネスト社製の制御装置により行った。N.RECS-ugは内寸0.2
m，長さ8
...
\pandocbounded{\includegraphics[keepaspectratio]{../figs/greenhouse20251119.png}}
...
\subsection{供試した根域温度制御用のヒートポンプの種類と性能}\label{ux4f9bux8a66ux3057ux305fux6839ux57dfux6e29ux5ea6ux5236ux5fa1ux7528ux306eux30d2ux30fcux30c8ux30ddux30f3ux30d7ux306eux7a2eux985eux3068ux6027ux80fd}
...
\subsection{各部位の温度と流速測定に用いたセンサーと消費電力量の計算方法}\label{ux5404ux90e8ux4f4dux306eux6e29ux5ea6ux3068ux6d41ux901fux6e2cux5b9aux306bux7528ux3044ux305fux30bbux30f3ux30b5ux30fcux3068ux6d88ux8cbbux96fbux529bux91cfux306eux8a08ux7b97ux65b9ux6cd5}
...
\fontsize{12.0pt}{14.0pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}ccllc}
\toprule
 &  & \multicolumn{2}{c}{根域温度の設定\textsuperscript{z}} &  \\ 
\cmidrule(lr){3-4}
...
\textsuperscript{z}\setstretch{1} N.RECS-hsの制御装置では他の2区とは異なり，設定温度に対して±0.5°Cのヒステリシスで制御されている。上限値を超えると冷却が始まり，下限値に達すると冷却が停止する。\\
\end{minipage}
...
\subsection{成績係数（COP）の計算方法}\label{ux6210ux7e3eux4fc2ux6570copux306eux8a08ux7b97ux65b9ux6cd5}
...
\end{aligned}
\] ブラインの比重と比熱はプロピレングリコール濃度が37
wt％，水温10°Cの時のデータである。プロピレングリコールの比熱と比重は，三菱電機空冷式ブラインクーラBFL−SP○○○E形取扱説明書（2011年1月作成）p28，図9-8　プロピレングリコール水溶液の比熱（0.9
cal/g）および図9-9から引用した。

\subsection{実験1 Water
HPの貯水槽水温の制御と水攪拌用エアポンプの作動の有無がCOPに与える影響}\label{ux5b9fux9a131-water-hpux306eux8cafux6c34ux69fdux6c34ux6e29ux306eux5236ux5fa1ux3068ux6c34ux652aux62ccux7528ux30a8ux30a2ux30ddux30f3ux30d7ux306eux4f5cux52d5ux306eux6709ux7121ux304ccopux306bux4e0eux3048ux308bux5f71ux97ff}

　Water
HPでは一次側の熱交換として井戸からくみ上げた地下水を使用している。一次側の熱交換を行うには十分量の地下水を利用する必要があるが，地下水は大量にくみ上げると地盤沈下を招くなどの環境影響があることから，一部の地域では取水量に制限ある。したがって，地下水熱利用を普及させるには一次側熱交換における，効率的な地下水の利用方法について検討する必要がある。そこで，本実験では異なる貯水槽水温と攪拌用空気ポンプの駆動がWater
HPの消費電力量とCOPに及ぼす影響について検討した。 　
　Table~\ref{tbl-well_setting}
に貯水槽に井戸水を注水する際の，貯水槽水温の注水開始と注水停止温度と空気ポンプの作動状況を示す。本実験は2025年8月16日から9月4日にかけて実施し，期間中にそれぞれの設定で2〜3日間連続して運用し，そのときの貯水槽水温，供給した井戸水の水温，期間中の消費電力量，COPを取り纏めた。

\begin{table}[H]

\caption{\label{tbl-well_setting}貯水槽への井戸水の注水開始・停止温度と空気ポンプの作動状況}
...
\toprule
 & \multicolumn{2}{c}{井戸水の注水} &  \\ 
\cmidrule(lr){2-3}
実施日 & 開始温度（$^\circ$C） & 停止温度（$^\circ$C） & 空気ポンプ \\ 
\midrule\addlinespace[2.5pt]
8月16日〜8月19日 & 22 & 21 & Off \\ 
8月22日〜8月24日 & 25 & 24 & Off \\ 
8月25日〜8月27 & 28 & 27 & Off \\ 
8月28日〜8月31日 & 22 & 21 & On \\ 
9月1日〜9月4日 & 22 & 21 & Off \\ 
\bottomrule
\end{tabular*}
...
\subsection{実験2　根域冷却がガーデンシクラメンの生育に及ぼす影響}\label{ux5b9fux9a132-ux6839ux57dfux51b7ux5374ux304cux30acux30fcux30c7ux30f3ux30b7ux30afux30e9ux30e1ux30f3ux306eux751fux80b2ux306bux53caux307cux3059ux5f71ux97ff}

　供試植物はガーデンシクラメン（\(Cyramen\) \(persicum\)
L.）'ベラノミックス'のセル成形苗を未来アグリスから購入し，2025年7月？日に3.5号鉢に鉢上げした。栽培用培地にはモノタロウから購入した培養土（53854938）と赤玉土（小粒）を等量混合したものを用い，鉢上げと同時に肥料としてマグァンプK（N-P\textsubscript{2=O}5\textsubscript{-K}2\textasciitilde O-MgO=6-40-6-15，（株）ハイポネックスジャパン）を一鉢当たり3gを施用した。
　 　 　 実験は2025年

\subsection{実験2}\label{ux5b9fux9a132}
