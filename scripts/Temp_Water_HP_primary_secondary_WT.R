...
#データ表示範囲指定
from <- as.POSIXct("2025-09-01 06:00:00", tz = tz_use) 
...
ggsave("/cloud/project/figs/Temp_Water_HP_0901_0904.pdf",
...
# ggsave("/cloud/project/figs/Temp_Water_HP_0901_0904.png",
#        plot =(pp_top / p_bottom) + plot_layout(guides = "keep"),
#        device=ragg::agg_png,
#        width = 10,
#        height = 18,
