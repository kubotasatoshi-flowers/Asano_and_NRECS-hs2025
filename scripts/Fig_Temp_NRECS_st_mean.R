...
df_day_t <- df_day_t %>%
  filter (Type %in%
            c("Cont_Soil_T_Cyclamen",
              "NRECS_st_whp_Cyclamen",
              "NRECS_st_ahp_Cyclamen"))
#作図するデータ系列を指定
...
col_map <- c("Cont_Soil_T_Cyclamen" ="darkgreen",
             "NRECS_st_whp_Cyclamen" = "red",
             "NRECS_st_ahp_Cyclamen" ="darkblue")

line_map <- c("Cont_Soil_T_Cyclamen" ="solid",
              "NRECS_st_whp_Cyclamen" = "solid",
              "NRECS_st_ahp_Cyclamen" ="solid") 

line_w_map<- c("Cont_Soil_T_Cyclamen" =0.3,
               "NRECS_st_whp_Cyclamen" = 0.3,
               "NRECS_st_ahp_Cyclamen" = 0.3) 
