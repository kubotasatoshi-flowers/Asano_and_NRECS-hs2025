...
#csvからデータ読み込み
# data <- read.table("/cloud/project/data/TEMP_Air_NRECS_all_20250929_mod.csv",
#                    sep=",",
#                    comment.char="#",
#                    header=T)
...
#データ表示範囲指定
from <- as.POSIXct("2025-07-15 00:00:00", tz = tz_use) 
to   <- as.POSIXct("2025-07-27 23:59:00", tz = tz_use)
