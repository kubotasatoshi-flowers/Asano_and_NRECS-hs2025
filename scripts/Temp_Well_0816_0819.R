...
#データ表示範囲指定
from <- as.POSIXct("2025-08-16 06:00:00", tz = tz_use) 
to   <- as.POSIXct("2025-08-19 06:00:00", tz = tz_use)
...
p <- ggplot(
  ...
  ggtitle("Bubbling:Off, Well_Sv:22°C/21°C") +
  theme_minimal() +
...
ggsave("/cloud/project/figs/Temp_well_0816_0819.pdf",
       plot = p,
       device=cairo_pdf,
       width = 15,
       height = 9,
